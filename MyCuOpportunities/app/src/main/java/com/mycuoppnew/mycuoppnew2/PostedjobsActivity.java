...
public class PostedjobsActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_postedjobs);
        ...
        String URL = "http://10.0.2.2:8888/mycuoppnew2/Postedjobs.php?email="+email;
        ...
        request = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    JSONArray searchresult = jsonObject.getJSONArray("postedjobs");
